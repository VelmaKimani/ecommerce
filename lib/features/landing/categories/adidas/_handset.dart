...
class AdidasPageHandset extends StatefulWidget {
  const AdidasPageHandset({super.key});

  @override
  State<AdidasPageHandset> createState() => _AdidasPageHandsetState();
}

class _AdidasPageHandsetState extends State<AdidasPageHandset> {
  late String selectedCategory = '';
  late Stream<QuerySnapshot> _shoesStream;
  List<ShoesModel> shoes = [];
  @override
  void initState() {
    super.initState();
    selectedCategory = 'Adidas';
    _shoesStream = FirebaseFirestore.instance.collection('Shoes').snapshots();
  }
    ...
    setState(() {
      ...
      if (category == 'Adidas') {
        ...
        _shoesStream = FirebaseFirestore.instance
            .collection('Shoes')
            .where('Adidas', isEqualTo: category)
            .snapshots();
      }
    });
  }
