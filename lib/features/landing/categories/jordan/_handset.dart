...
class JordanPageHandset extends StatefulWidget {
  const JordanPageHandset({super.key});

  @override
  State<JordanPageHandset> createState() => _JordanPageHandsetState();
}

class _JordanPageHandsetState extends State<JordanPageHandset> {
    ...
    setState(() {
      ...
      if (category == 'Jordan') {
        ...
        _itemsStream = FirebaseFirestore.instance
            .collection('Shoes')
            .where('Jordan', isEqualTo: category)
            .snapshots();
      }
    });
  }
